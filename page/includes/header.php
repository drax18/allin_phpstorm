...
<head>
    ...
    <!-- Custom -->
    <link href="page/css/bootstrap-image-gallery.css" rel="stylesheet">
    <link rel="stylesheet" href="//blueimp.github.io/Gallery/css/blueimp-gallery.min.css">

    <!-- Media  -->
    <link href="page/css/media.css" rel="stylesheet">

    <!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries + personal ie9fix -->
    <!--[if gte IE 9]>
    ...
    <script type="text/javascript" src="page/js/bootstrap-image-gallery.min.js"></script>
